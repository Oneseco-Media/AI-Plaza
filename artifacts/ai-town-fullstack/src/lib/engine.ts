...
// Base URL for the AI Town API — uses Vite's BASE_URL so it works under any path prefix
const AI_API_BASE = `${import.meta.env.BASE_URL}api/ai-town`.replace(/\/+/g, "/").replace(/^\/?/, "/");
